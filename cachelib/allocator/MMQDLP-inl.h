...
template <typename T, MMQDLP::Hook<T> T::*HookPtr>
void MMQDLP::Container<T, HookPtr>::updateLruInsertionPoint() noexcept {
...
MMQDLP::Container<T, HookPtr>::getEvictionIterator() const noexcept {
...
template <typename T, MMQDLP::Hook<T> T::*HookPtr>
void MMQDLP::Container<T, HookPtr>::ensureNotInsertionPoint(T& node) noexcept {
...
template <typename T, MMQDLP::Hook<T> T::*HookPtr>
void MMQDLP::Container<T, HookPtr>::remove(Iterator& it) noexcept {
  T& node = *it;
...
template <typename T, MMQDLP::Hook<T> T::*HookPtr>
MMQDLP::Container<T, HookPtr>::LockedIterator::LockedIterator(
